...
Hex.arm_and_takeoff(10)                                    # run arm and take off function
Hex.fly_to_point(waypoint, airspeed, plant_flag)           # run fly to point function
time.sleep(5)
Hex.descend(plant_alt)                                     # run descend function
Hex.plant()                                                # run plant function
Hex.ascend(flying_alt)                                     # run ascend function
Hex.return_home()                                          # run return home function
